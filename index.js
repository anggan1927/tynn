...
m.reply(`http://wa.me/62895414262481
Itu Link Menuju chat owner kak`)
}
break
            case 'rules':{
...
break
			...
			case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} tynn, 12, 1, 2004, Clara, 22, 2, 2004`
            ...
            break
            case 'artinama': {
                if (!text) throw `Example : ${prefix + command} tynn`
            ...
            case 'kecocokannama': case 'cocoknama': {
                if (!text) throw `Example : ${prefix + command} tynn, 12, 1, 2004`
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                if (!text) throw `Example : ${prefix + command} tynn|Clara`
            ...
            break
            case 'fengshui': {
                if (!text) throw `Example : ${prefix + command} tynn, 1, 2004\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            break
            case 'peruntungan': {
                if (!text) throw `Example : ${prefix + command} tynn, 12, 1, 2004, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
if (!text) return reply(`Kirim perintah ${prefix + command} *tynn*`)
reply(lang.wait())
...
if (!text) return reply(`Kirim perintah ${prefix + command} *tynn|ofc*`)
if (!text.includes('|')) return reply(`Kirim perintah ${prefix + command} *tynn|ofc*`)
mm = args.join(' ')
m1 = mm.split("|")[0];
m2 = mm.split("|")[1]; 
reply(lang.wait())
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'astronotspace':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|anubis`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|anubis`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'wallpaperaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} tynn|allain`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} tynn|allain`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'wallpaperml':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} tynn|aldous`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} tynn|aldous`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'bannerofaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|aphelios`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|aphelios`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'cutegirlgamer':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|style-1`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|style-1`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'footballteam':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|nau-1`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|nau-1`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	case 'elegantrotation':{
		if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|bull`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|bull`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {video:{ url: textpro2}, mimetype: 'video/mp4', caption: lang.ok()}, {quoted:m})
	...
	break
case 'gaminglogo4fvs':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|ghost`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|ghost`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'blueneon':{
		if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|tiger`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} tynn|tiger`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'anonymous':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|style2`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|style2`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'lolpentakill':{
		if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|kassadin`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|kassadin`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|arum-6`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|arum-6`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'avatarff':{
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|laura`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|laura`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|ashe-2`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} tynn|ashe-2`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'crossfirecover':{
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|blthefates`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|blthefates`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|dieuthuyen`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} tynn|dieuthuyen`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'newlolavatar':{
if (!text) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} tynn|rammus`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} tynn|rammus`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'csgocover':{
if (!text) return reply(`Ex: ${prefix + command} nama|background\nUsage: ${prefix + command} tynn|karambit`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|background\nUsage: ${prefix + command} tynn|karambit`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'crossfirestyle':{
if (!text) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} tynn|swat`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} tynn|swat`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
